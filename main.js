...
document.getElementById("t").innerHTML="Timer:"+random_no;
tc=0;
tch="";
ds="";
ah="";
...
function check(){
    tc=tc+1;
    document.getElementById("t").innerHTML="Timer:"+tc;
    console.log(tc);
    if(tc>400){
        tc=0;
        tch="completed"
...
function gr(error,result){
    ...
    ds=result[0].label;
    document.getElementById("s").innerHTML="Your Sketch:"+ds;
    document.getElementById("c").innerHTML="Confidence:"+Math.round(result[0].confidence*100)+"%";
    }